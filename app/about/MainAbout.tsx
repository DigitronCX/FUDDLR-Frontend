            ...
            <div className="mx-auto grid md:grid-cols-2 gap-5 items-center">
                ...
                <div>
                    ...
                    <h2 className="text-4xl md:text-5xl mb-6 text-secondary font-youngSerif">
                        About <span className="text-green-500">Our Journey</span>
                    </h2>

                    <p className="text-primary mb-4 leading-relaxed">
                        At FUDDLR, we believe pets are more than just animals—they are
                        family. Our goal is simple: to bring better, cleaner, and more honest
                        food choices to the pets we love.
                    </p>

                    <p className="text-primary mb-6 leading-relaxed">
                        We work with brands that care about what goes into their products,
                        focusing on real ingredients, thoughtful nutrition, and complete
                        transparency. Because when it comes to our pets, only the best will
                        do.
                    </p>
