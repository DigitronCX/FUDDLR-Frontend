                ...
                <div className="bg-white rounded-4xl border-2 border-brand p-6 sm:p-8 shadow-sm">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={!agreed}
                            className={`w-full group relative inline-flex items-center justify-center overflow-hidden bg-secondary rounded-full border border-secondary px-4 sm:px-6 lg:px-8 py-3 md:py-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/30 ${!agreed ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                        >
