            ...
            <div className="mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div>
                    ...
                    <p className="mt-6 text-gray-600 max-w-lg leading-relaxed">
                        Partner with Fuddlr to access a boutique distribution model designed
                        to help your brand stand out & not get lost. We work closely with a
                        curated selection of brands, offering dedicated support, retail
                        connections, and optional sales growth packages to help you scale in
                ...
                <div className="bg-green-100 border border-green-400 rounded-3xl flex flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="flex-1 p-6">
                        ...
                        <p className="mt-2 text-gray-600 text-sm">
                            Sales consulting & brand-building services to strengthen market
                            positioning.
                        </p>
                    </div>
